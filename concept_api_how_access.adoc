...
---
= 了解如何存取 ONTAP Select Deploy API
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: ONTAP Select Deploy 中所包含的 REST API 被指派了一個版本號碼。此 API 版本號與 Deploy 版本號無關。ONTAP Select 9.19.1 Deploy 管理公用程式包含 REST API 的版本 3。
