...
一個包含中間節點的雙節點叢集可以跨越兩個資料中心。如需更多資訊，請參閱 link:reference_plan_best_practices.html#two-node-stretched-ha-metrocluster-sds-best-practices["雙節點延伸HA MetroCluster （簡稱「架構SDS」）最佳實務做法"] 章節。
