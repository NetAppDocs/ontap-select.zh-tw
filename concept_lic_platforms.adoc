...
2+| 部署選項 3+| 單節點集群、雙節點集群（HA 對）、四節點、六節點、八節點、十節點或十二節點集群 
...
2+| CPU 系列  a| 
Intel Xeon E5-26xx v3 （ Haswell ）或更新版本

AMD EPYC Embedded 9004 或更新版本和 8004
 a| 
Intel Xeon E5-26xx v3 （ Haswell ）或更新版本
...
2+| 網路（每個節點） 3+| 單節點叢集至少需要兩個 1GbE 連接埠；雙節點叢集（HA 對）至少需要四個 1GbE 連接埠；四節點、六節點、八節點、十節點或十二節點叢集至少需要兩個 10GbE 連接埠。 
|===
...
====
.下一步是什麼？
瞭解 link:concept_lic_workflow.html["購買 ONTAP Select 授權"]
