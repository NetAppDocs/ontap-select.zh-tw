...
NOTE: 限制 ONTAP 管理員帳戶的角色和權限可能會限制 ONTAP Select Deploy 管理叢集的能力。如需詳細資訊，請參閱知識庫文章 link:https://kb.netapp.com/onprem/ontap/ONTAP_Select/OTS_Deploy_cluster_refresh_fails_with_error%3A_ONTAPSelectSysCLIVersionFailed_zapi_returned_bad_status_0%3A_None["OTS 部署叢集重新整理失敗、並出現錯誤"^]。
...
* link:reference_lic_ontap_features.html["預設授權的 ONTAP 功能"]
