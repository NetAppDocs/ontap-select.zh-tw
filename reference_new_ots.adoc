...
--
支援 SnapLock Select:: 從 ONTAP Select 9.17.1 開始，新部署會自動授權 SnapLock Select（包括防篡改 Snapshot 鎖定）。若要從 ONTAP Select 9.16.1 及更早版本升級，您可以從link:https://mysupport.netapp.com/site/["NetApp 支援網站"^]免費下載 SnapLock Select 授權並手動套用。如需詳細資訊，請參閱link:reference_lic_ontap_features.html#licensed-ontap-features["預設授權的 ONTAP 功能"]。
