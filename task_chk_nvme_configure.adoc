...
* 對於 KVM 主機，需要ONTAP Select 9.17.1 或更高版本以及受支援的部署管理實用程式。
* 優質XL平台授權方案或90天試用授權
...
請按照 link:kvm-host-configuration-and-preparation-checklist.html["主機準備檢查清單"] 操作,並查看 link:reference_chk_deploy_req_info.html["部署實用程式安裝"] 和 link:reference_chk_select_req_info.html["ONTAP Select安裝"] 所需的資訊以了解更多資訊。
